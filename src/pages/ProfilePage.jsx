...
function ProfilePage() {
  ...
  const handleInputChange = (e) => {
    ...
    // Validation for first and last name: only characters allowed
    if (name === 'firstName' || name === 'lastName') {
      const charOnlyRegex = /^[A-Za-z\s]*$/;
      if (!charOnlyRegex.test(value)) {
        addToast('Only letters are allowed in name fields', 'error');
                ...
                <div className="bg-white rounded-2xl md:rounded-3xl border border-gray-100 p-4 md:p-8 shadow-sm">
                  ...
                  <form className="space-y-6 md:space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                      {/* ... first name ... */}
                      <div>
                        <label htmlFor="p-firstName" className="block text-[10px] md:text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-2 md:mb-3 ml-2">FIRST NAME</label>
                        <input
                          type="text"
                          id="p-firstName"
                          name="firstName"
                      ...
                      <div>
                        <label htmlFor="p-lastName" className="block text-[10px] md:text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-2 md:mb-3 ml-2">LAST NAME</label>
                        <input
                          type="text"
                          id="p-lastName"
                          name="lastName"
                    ...
                    <div>
                      <label htmlFor="p-phone" className="block text-[10px] md:text-[11px] font-bold text-gray-400 tracking-wider uppercase mb-2 md:mb-3 ml-2">PHONE NUMBER</label>
                    ...
                    <div className="pt-2 md:pt-4 pb-4 md:pb-8">
                      ...
                      {isEditing ? (
                        <div className="space-y-4 md:space-y-6 bg-[#F8FAFC] p-4 md:p-6 rounded-xl md:rounded-2xl border border-gray-100">
                          <div>
                            <label htmlFor="p-address" className="block text-[10px] font-bold text-gray-400 tracking-wider uppercase mb-2 ml-1">STREET ADDRESS</label>
                            <input
                              type="text"
                              id="p-address"
                              name="address"
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <label htmlFor="p-city" className="block text-[10px] font-bold text-gray-400 tracking-wider uppercase mb-2 ml-1">CITY</label>
                              <input
                                type="text"
                                id="p-city"
                                name="city"
                            ...
                            <div>
                              <label htmlFor="p-pincode" className="block text-[10px] font-bold text-gray-400 tracking-wider uppercase mb-2 ml-1">POSTAL CODE</label>
                              <input
                                type="text"
                                id="p-pincode"
                                name="pincode"
